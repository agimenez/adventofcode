...
should choose Rock (`X`). This ends in a loss for you with a score of **1** (1 + 0).
...
second column says how the round needs to end: `X` means you need to lose, `Y` means you
need to end the round in a draw, and `Z` means you need to win. Good luck!"
