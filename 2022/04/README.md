...
Every section has a unique **ID number**, and each Elf is assigned a range of section
IDs.
...
other. For example, `2-8` fully contains `3-7`, and `6-6` is fully contained by `4-6`. In
pairs where one assignment fully contains the other, one Elf in the pair would be
